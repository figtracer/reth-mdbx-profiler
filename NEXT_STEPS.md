...
#define P_LARGE   0x04   // Large/overflow page (large values)
...
int BPF_KRETPROBE(trace_page_fault_ret, vm_fault_t ret) {
    ...
    // Read page header to get type - flags are at offset 10!
    __u64 page_start = fctx->address & ~0xFFFULL;  // Align to 4KB page
    __u16 page_flags = 0;
    bpf_probe_read_user(&page_flags, 2, (void *)(page_start + 10));
